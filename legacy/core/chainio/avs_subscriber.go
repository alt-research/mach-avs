...
func BuildAvsSubscriber(registryCoordinatorAddr, blsOperatorStateRetrieverAddr gethcommon.Address, ethclient eth.HttpBackend, logger sdklogging.Logger) (*AvsSubscriber, error) {
