...
type AlertTaskInfo struct {
	...
	QuorumThresholdPercentages []uint32 `protobuf:"varint,3,rep,packed,name=quorum_threshold_percentages,json=quorumThresholdPercentages,proto3" json:"quorum_threshold_percentages,omitempty"`
	// TaskIndex
...
func (x *AlertTaskInfo) GetQuorumNumbers() []uint32 {
	if x != nil {
...
func (x *AlertTaskInfo) GetQuorumThresholdPercentages() []uint32 {
	if x != nil {
...
var file_aggregator_aggregator_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0d, 0x52, 0x0d, 0x71, 0x75, 0x6f, 0x72, 0x75, 0x6d, 0x4e, 0x75, 0x6d, 0x62,
	...
	0x67, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x1a, 0x71, 0x75, 0x6f, 0x72, 0x75,
